...
function loadCandidateEducationData() {
    ...
    $('#btnEducationCancel').on('click', function () {
        $('#degreeLevelId').val('');
        $('#degreeLevelId').
            select2({ 'width': '100%', 'placeholder': Lang.get('messages.company.select_degree_level') });
        hideAddEducationDiv();
    });
    ...
    listenClick('.delete-experience', function (event) {
        ...
        deleteItem(route('experience.destroy', experienceDeleteId), Lang.get('messages.candidate.experience'),
    ...
    listenClick('.delete-education', function (event) {
        ...
        deleteItem(route('education.destroy', educationId),
            Lang.get('messages.candidate_profile.education'),
            '.candidate-education-container', '.candidate-education',
            '#notfoundEducation');
        $('#degreeLevelId').find('option[value=""]').remove();
        $('#degreeLevelId').prepend(
            $(`<option value="" selected>${Lang.get('messages.company.select_degree_level')}</option>`));
    });
    ...
    window.showAddEducationDiv = function () {
        ...
        $('#cvEducationStateId').select2({'width': '100%', 'placeholder': Lang.get('messages.company.select_state')});
        $('#cvEducationCityId').select2({'width': '100%', 'placeholder': Lang.get('messages.company.select_city')});
    ...
    window.showAddExperienceDiv = function () {
        ...
        $('#stateId').
            select2({ 'width': '100%', 'placeholder': Lang.get('messages.company.select_state') });
        $('#cityId').select2({ 'width': '100%', 'placeholder': Lang.get('messages.company.select_city') });
